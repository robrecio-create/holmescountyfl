export const towns = [
  { name: 'Bonifay', slug: 'bonifay', businesses: 0 },
  { name: 'Westville', slug: 'westville', businesses: 0 },
  { name: 'Ponce de Leon', slug: 'ponce-de-leon', businesses: 0 },
  { name: 'Esto', slug: 'esto', businesses: 0 },
  { name: 'Noma', slug: 'noma', businesses: 0 },
